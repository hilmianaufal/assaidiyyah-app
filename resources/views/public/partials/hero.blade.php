<section class="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-950 via-blue-800 to-cyan-700 px-4 pb-20 pt-32 text-white">
    ...
    <div class="relative z-10 mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
        ...
        <div class="js-hero relative">
            <div class="rounded-[2.5rem] border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur-xl">
                ...
                <div class="overflow-hidden rounded-[2rem]">
                    <img
                        ...
                        class="aspect-[16/9] w-full object-cover lg:aspect-auto lg:h-[420px]">
                </div>
                @else
           ...
           <div class="absolute -bottom-4 left-3 right-3 rounded-2xl bg-white p-3 text-slate-900 shadow-2xl sm:-bottom-6 sm:left-6 sm:right-6 sm:p-5">
                ...
                @empty
                    ...
                    <p class="mt-1 text-sm font-bold text-blue-600">
                        Pantau informasi kegiatan terbaru pondok.
                    </p>
                @endforelse
            </div>
        </div>
