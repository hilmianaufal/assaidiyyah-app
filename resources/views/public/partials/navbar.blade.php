<header x-data="{ open: false }" class="fixed inset-x-0 top-0 z-50">
    <div class="mx-auto max-w-7xl px-4 pt-4">
        <nav class="rounded-3xl border border-white/15 bg-white/10 px-4 py-3 shadow-2xl backdrop-blur-2xl">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-sm font-black leading-tight text-white sm:text-lg">
                            Assaidiyyah
                        </h1>
                ...
                <div class="hidden items-center gap-8 text-sm font-bold text-blue-50 lg:flex">
                    <a href="{{ route('programs.index') }}" class="transition hover:text-cyan-300">Program</a>
                    <a href="{{ route('news.index') }}" class="transition hover:text-cyan-300">Berita</a>
                    <a href="{{ route('achievements.index') }}"
                        class="transition hover:text-cyan-300">
                            Prestasi
                        </a>
                    <a href="{{ route('gallery.index') }}" class="transition hover:text-cyan-300">Galeri</a>
                    <a href="{{ route('about') }}" class="transition hover:text-cyan-300">Tentang</a>
                    <a href="{{ route('contact') }}" class="transition hover:text-cyan-300">Kontak</a>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button type="button"
                            @click="open = !open"
                            class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/10 text-xl text-white lg:hidden">
                        ☰
                    </button>
                </div>
