<x-admin-layout>
    <div class="space-y-6">
        ...
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-yellow-400 via-emerald-500 to-cyan-600 p-6 sm:p-8 text-white shadow-2xl shadow-emerald-200">
            ...
            <p class="mt-2 max-w-xl text-white/90">
                Perbarui nama, ikon, gambar, urutan, dan deskripsi program.
            </p>
        </div>
