<x-admin-layout>
    <div class="space-y-6">
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-yellow-400 via-blue-600 to-cyan-600 p-6 sm:p-8 text-white shadow-2xl shadow-blue-200">
            ...
            <p class="mt-2 max-w-xl text-white/90">
                Perbarui nama, foto, kelas, peran, dan biografi penulis.
            </p>
        </div>
