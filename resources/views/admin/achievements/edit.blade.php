...
<x-admin-layout>
    <div class="space-y-6">
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-yellow-300 via-orange-500 to-red-500 p-6 sm:p-8 text-white shadow-2xl shadow-orange-200">
            ...
            <p class="mt-2 max-w-xl text-white/90">
                Perbarui data prestasi, foto, kategori, tingkat, dan status publikasi.
            </p>
        </div>

        <form action="{{ route('admin.achievements.update', $achievement) }}"
              method="POST"
