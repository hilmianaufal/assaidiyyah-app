    ...
    <div class="space-y-6">
        ...
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-pink-500 via-rose-500 to-orange-400 p-6 sm:p-8 text-white shadow-2xl shadow-pink-200">
            ...
            <p class="mt-2 max-w-xl text-white/90">
                Upload dokumentasi kegiatan, fasilitas, atau momen penting pondok.
            </p>
        </div>
        ...
        <form action="{{ route('admin.galleries.store') }}"
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                <button type="submit"
                        class="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-pink-500 to-orange-400 px-5 py-4 font-black text-white shadow-xl shadow-pink-200">
                    💾 Simpan Foto
                </button>
